...
Процедура ДобавитьКомандуДобавитьМодели(ТаблицаКоманд, НастройкиФормы) Экспорт
	...
	КомандаОтбора.Вид = "КаталогАвтомобилей";
	КомандаОтбора.Представление = НСтр("ru= 'Добавить модели автомобилей'");
	КомандаОтбора.Обработчик = "КА2_ПодключаемыеКомандыКлиент.Подключаемый_ОткрытьФормуДобавитьМоделейАвтомобилей";
	КомандаОтбора.ИмяФормы = "ФормаСписка";
	КомандаОтбора.РежимЗаписи = "Записывать";
	КомандаОтбора.МножественныйВыбор = Истина;
	КомандаОтбора.ИзменяетВыбранныеОбъекты = Истина;
	КомандаОтбора.Порядок = 96;
